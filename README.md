# nvim-treesitter-queries-fidl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-fidl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-fidl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **fidl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-fidl",
...
- [ ] Changes are scoped to `fidl` — do not include files for other languages
